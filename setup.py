...
setup(
    ...
    name='gmkt_srp_python_dweb_test',
    # 배포할 패키지의 버전을 적어줍니다. 첫 등록이므로 0.1 또는 0.0.1을 사용합니다.
    version='0.1.1',
    # 배포할 패키지에 대한 설명을 작성합니다.
    description='First Line Check Test Automation',
    # 배포하는 사람의 이름을 작성합니다.
    author='taeshik.kim',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email='taeshkim@gmarket.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url='http://github.gmarket.com/test-automation/gmkt_srp_python_dweb_test',
    ...
    install_requires=['selenium','numpy','pytest','requests','assertpy','pyautogui','opencv-python'],
    # 등록하고자 하는 패키지를 적는 곳입니다.
    # 우리는 find_packages 라이브러리를 이용하기 때문에 아래와 같이 적어줍니다.
    # 만약 제외하고자 하는 파일이 있다면 exclude에 적어줍니다.
    packages=['src/gmkt_srp_python_dweb_page'],
    # 패키지의 키워드를 적습니다.
    keywords=['gmarket'],
